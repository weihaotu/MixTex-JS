...
function requireReactDomClient_production() {
  ...
  var ReactSharedInternals = React2.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE, assign2 = Object.assign, prefix2, suffix;
...
const DragHandle = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Handle,
    {
      ...
      onMouseMove: onDrag,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { src: "../../assets/icon.png", alt: "MixTeX" })
    }
  );
};
const spin = mt`
...
`;
const SpinnerText = dt.div`
  margin-left: 12px;
  color: ${(props) => props.theme.colors.text};
  font-size: 14px;
`;
const Spinner = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(SpinnerContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SpinnerCircle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(SpinnerText, { children: "正在识别..." })
  ] });
};
...
const OutputArea = ({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Container, { children: [
    ...
    isProcessing && /* @__PURE__ */ jsxRuntimeExports.jsx(Spinner, {})
  ] });
};
...
const SettingsProvider = ({ children }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsContext.Provider, { value: { settings, updateSettings }, children });
};
const useSettings = () => reactExports.useContext(SettingsContext);
const Panel$2 = dt.div`
  position: absolute;
  top: 40px;
  right: 12px;
...
const SettingsPanel = ({ onClose }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel$2, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SettingItem, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "使用 $ 符号" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => updateSettings("useInlineDollars", e.target.checked),
            style: { display: "none" }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { checked: settings.useInlineDollars })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SettingItem, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "转换对齐为单行公式" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => updateSettings("convertAlignToEquations", e.target.checked),
            style: { display: "none" }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { checked: settings.convertAlignToEquations })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(SettingItem, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "仅在窗口显示时识别" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Switch, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            onChange: (e) => updateSettings("onlyParseWhenShow", e.target.checked),
            style: { display: "none" }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Slider, { checked: settings.onlyParseWhenShow })
      ] })
    ] })
  ] });
};
const Panel$1 = dt.div`
  position: absolute;
  top: 50%;
  left: 50%;
  transform: translate(-50%, -50%);
...
const ButtonGroup = dt.div`
  ...
  margin-bottom: 16px;
`;
const FeedbackButton = dt.button`
  padding: 8px;
  ...
  &:hover {
    background: ${(props) => props.selected ? props.theme.colors.primaryDark : props.theme.colors.surface};
  }
`;
...
const FeedbackPanel = ({ onClose }) => {
  ...
  const [annotation, setAnnotation] = reactExports.useState("");
  const handleSubmit = () => {
    window.electron.feedback.save({
      image: "",
      // 这里需要实际的图片数据
      text: feedbackType,
      feedback: annotation.trim()
    });
    onClose();
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel$1, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Title$1, { children: "反馈" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(SubmitButton, { onClick: handleSubmit, children: "提交反馈" })
  ] });
};
const Panel = dt.div`
  position: absolute;
...
const Title = dt.h1`
  ...
  margin-bottom: 8px;
`;
const Version = dt.div`
  color: ${(props) => props.theme.colors.text};
  opacity: 0.7;
  margin-bottom: 16px;
`;
const InfoList = dt.div`
  text-align: left;
  margin-bottom: 24px;
`;
...
const AboutPanel = ({ onClose }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(Panel, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Logo, { src: "../../assets/icon.png", alt: "MixTeX" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Title, { children: "MixTeX" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Version, { children: "版本: 0.0.1" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoList, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(InfoItem, { children: "作者: MarveelT" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(InfoItem, { children: [
        "Github：",
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "https://github.com/weihaotu", target: "_blank", rel: "noopener noreferrer", children: "github.com/weihaotu" })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CloseButton, { onClick: onClose, children: "关闭" })
  ] });
};
const Bar = dt.div`
  height: 40px;
...
const ControlBar = () => {
  ...
  const handleCopy = () => {
    window.electron.clipboard.copy("");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Bar, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleCopy, children: "复制" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setShowSettings(true), children: "设置" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setShowFeedback(true), children: "反馈" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: () => setShowAbout(true), children: "关于" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleMinimize, children: "最小化" })
    ] }),
    showSettings && /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsPanel, { onClose: () => setShowSettings(false) }),
    showFeedback && /* @__PURE__ */ jsxRuntimeExports.jsx(FeedbackPanel, { onClose: () => setShowFeedback(false) }),
    showAbout && /* @__PURE__ */ jsxRuntimeExports.jsx(AboutPanel, { onClose: () => setShowAbout(false) })
  ] });
};
const WindowContainer = dt.div`
  width: 100vw;
  height: 100vh;
  background: ${(props) => props.theme.colors.background};
  border: 1px solid ${(props) => props.theme.colors.border};
...
const MainWindow = () => {
  ...
  reactExports.useEffect(() => {
    const handleOcrResult = (_2, result) => {
      setOutput(result);
      setIsProcessing(false);
    };
    const handleOcrError = (_2, error) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(WindowContainer, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      DragHandle,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(ControlBar, {})
  ] });
};
const theme = {
  colors: {
...
`;
const App = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ot, { theme, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SettingsProvider, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(GlobalStyle, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(MainWindow, {})
  ] }) });
};
